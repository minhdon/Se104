...
export const Login = () => {
  ...
  return (
    <>
      <section className={styles.loginZone}>
        <div className={styles["login-container"]}>
          <div className={styles["logo-area"]}>
            ...
            <h1 className={styles["app-title"]}>Cloud Airlines</h1>
            <p className={styles["app-subtitle"]}>
              Chào mừng bạn quay trở lại chuyến bay.
            </p>
          </div>
          ...
          <form action="#" method="POST">
            ...
            <div className={styles["links-area"]}>
              ...
              <span>|</span>
              <a href="/change" className={styles.link}>
                Đổi mật khẩu
              </a>
            </div>
